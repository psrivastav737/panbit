...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="main-page.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>User Dash Board </a></h1></li>
									...
									<li>
										<a href="userstatus.php">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub">User profile</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="jobrunstatus.php">
										  <i class="fa fa-user" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one">2</h4>
												<h3 class="ca-sub one">running job status</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="completejob.php">
											<i class="fa fa-database" aria-hidden="true"></i>
											<div class="ca-content">
											<h4 class="ca-main two">3</h4>
												<h3 class="ca-sub two">complete jobs</h3>
											</div>
										</a>
									</li>
									<li>
...
<div class="copyrights">
	 <p>© 2018 <b>panBit</b> Services provider. All Rights Reserved | Design by  <a href="psrivastav737@gmail.com/" target="_blank">prakash srivastav</a> </p>
</div>	
