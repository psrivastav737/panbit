...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
            ...
            <!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href="main-page.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>User Profile</a></h1></li>
...
<div class="clearfix"></div>
		...
		<div class="tp">
	   <input type="submit" value="LOGIN" id= "submit" onclick= "sub();">
	</div>
	</form>
	</div>
...
<div class="copyrights">
	 <p>© 2017 Esteem. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">HestJob Bidder</a> </p>
</div>	
